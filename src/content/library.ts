...
export const archetypes: Record<number, Archetype> = {
  ...
  5:  { name: { ru: 'Исследователь', en: 'The Explorer' }, desc: { ru: 'Вам интересен мир во всех его проявлениях. Перемены для вас — не угроза, а приглашение.', en: 'The world in all its forms fascinates you. Change is not a threat but an invitation.' }, strength: { ru: 'гибкость и любознательность', en: 'flexibility and curiosity' } },
  ...
  7:  { name: { ru: 'Мудрец', en: 'The Sage' }, desc: { ru: 'Вы любите смотреть вглубь. Ваши выводы часто оказываются на шаг впереди.', en: 'You love looking deeper. Your conclusions are often one step ahead.' }, strength: { ru: 'глубина мышления', en: 'depth of thought' } },
  8:  { name: { ru: 'Мастер результата', en: 'Master of Results' }, desc: { ru: 'Вы умеете доводить до конца и превращать усилия в ощутимые плоды.', en: 'You know how to finish things and turn effort into tangible results.' }, strength: { ru: 'практическая сила', en: 'practical power' } },
  9:  { name: { ru: 'Даритель', en: 'The Giver' }, desc: { ru: 'Ваш взгляд шире личного. Вы умеете вдохновлять и делиться, не теряя себя.', en: 'Your view is wider than the personal. You inspire and share without losing yourself.' }, strength: { ru: 'великодушие', en: 'generosity of spirit' } },
